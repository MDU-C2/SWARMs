...
protected:
    ...
    left_received_(0), right_received_(0), left_info_received_(0), right_info_received_(0), all_received_(0)
  {
    ...
    std::string left_topic = "/camera_left_rect/image_color";
    std::string right_topic = "/camera_right_rect/image_color";

    std::string left_info_topic = "/camera_left_rect/camera_info";
